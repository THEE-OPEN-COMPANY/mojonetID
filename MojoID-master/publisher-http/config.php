...
$site_domain = "mojoid.bit";
$privatekey = // your site privatekey

$mojonet_dir = // your mojonet installation dir
$users_json = "$mojonet_dir/data/$site/data/users.json";
$users_archive_json = "$mojonet_dir/data/$site/data/users_archive.json";
?>